...
namespace CoreV1.Models.Brand
{
    public class BrandModel : BaseEntity
    {
        ...
        public int ParentManufIid { get; set; }
        ...
        //public IList<LocalizedEntity> LocalizedPropertySet { get; set; }
        //public IList<ContentDomainMapping> AllowedDomains { get; set; }
        public int NoOfSubManufacturers { get; set; }
        ...
        public string ManufacturerSettings { get; set; }
        ...
        //public List<BrandSettings> ManufacturerWidgets { get; set; }
        ...
        public List<MasterData> BrandDisplayTemplates { get; set; }
    }

    //public class BrandMediaFileItem
    //{
    ...
    //    public string Name { get; set; }
    //    public string ManufacturerSettingType { get; set; }
